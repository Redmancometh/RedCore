...
public class JedisObjectManager<T extends Syncable> extends XComManager<T>
{

    /**
     * Renamed to this long as shit, so I don't have to keep
     * confusing jedis. and jedis().
     */
    ...
    public Jedis jedis()
    {
        if (internalJedisInstance == null) return new Jedis(redisAddress);
    ...
    {
        jedis().set(getKey() + "-" + e.getUniqueId().toString(), json(e));
