...
public class ConfigManager<T>
{
        ...
        for (Field f : c.getDeclaredFields())
        {
            try
            {
                try
                {
                    ...
                    System.out.println("?e" + f.getName() + "?b = ?f" + gson.toJson(fieldValue, f.getGenericType()) + "\n");
                }
                catch (Throwable e)
                {
                    System.out.println("?cField ?e" + f.getName() + "?c was unable to be retrieved!\n");
                }
            }
            catch (Throwable e)
            {
    ...
    public static ConfigManager tryDebugPrint(RedPlugin plugin)
    {
        try
        {
            Object config = plugin.getClass().getDeclaredMethod("getCfg").invoke(null);
