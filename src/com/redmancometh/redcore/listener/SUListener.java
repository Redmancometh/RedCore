...
public class SUListener implements Listener, CommandExecutor
{
    ...
    public boolean onCommand(final CommandSender sender, Command command, String label, String[] args)
    {
        try
        {
            ...
            {
                case "help":
                    sender.sendMessage("§6§lRedCore - help menu\n" + "§b§l➯ §e§lCONTACT:§f on Skype - gyurixdev\n" + "§b§l➯ §e§lSUBCOMMANDS:§f\n" + "§b§l➯ §6/sl§e [p:players]§6§l cmd§e <commands>\n" + "§b§l➯ §6/sl§e [p:players]§6§l perm§e [perm]\n" + "§b§l➯ §6/sl§e [p:players]§6§l vars§e [text]\n" + "§b§l➯ §6/sl§e [p:players]§6§l velocity§e <x> <y> <z>");
                    return true;
                case "cmd":
                    for (Player p : pls)
                    {
