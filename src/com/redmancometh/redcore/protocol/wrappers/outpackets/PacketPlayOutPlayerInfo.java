...
public class PacketPlayOutPlayerInfo extends WrappedPacket
{
    ...
    public static class PlayerInfoData implements WrappedData
    {
        ...
        private static final Field pingF = Reflection.getFirstFieldOfType(vanillaCl, int.class), gpF = Reflection.getFirstFieldOfType(vanillaCl, com.mojang.authlib.GameProfile.class), gmF = Reflection.getFirstFieldOfType(vanillaCl, WorldType.enumGmCl), icbcF = Reflection.getFirstFieldOfType(vanillaCl, ChatAPI.icbcClass);
        private static final Constructor vanillaConst = Reflection.getConstructor(vanillaCl, vanillaParent, com.mojang.authlib.GameProfile.class, int.class, WorldType.enumGmCl, ChatAPI.icbcClass);
        ...
        public Object toNMS()
        {
            try
            {
                return vanillaConst.newInstance(null, gameProfile.toNMS(), ping, WorldType.toVanillaGameMode(gameMode), displayName == null ? null : displayName.toICBC());
            } catch (Throwable e)
            {
