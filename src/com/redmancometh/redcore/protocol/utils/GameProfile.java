...
public class GameProfile implements WrappedData
{
    ...
    public static final Field fid = Reflection.getField(cl, "id"), fname = Reflection.getField(cl, "name"), fproperties = Reflection.getField(cl, "properties"), flegacy = Reflection.getField(cl, "legacy");
    public boolean demo;
    public UUID id;
    ...
    public static class Property implements WrappedData
    {
        ...
        private static final Field fname = Reflection.getField(cl, "name"), fvalue = Reflection.getField(cl, "value"), fsignature = Reflection.getField(cl, "signature");
        public String name;
