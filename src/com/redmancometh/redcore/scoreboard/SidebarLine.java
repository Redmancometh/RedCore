...
import com.redmancometh.redcore.protocol.wrappers.outpackets.PacketPlayOutScoreboardScore.ScoreAction;
...
public class SidebarLine
{
    ...
    public void setText(String text)
    {
        ...
        if (!set[1].equals(oldUser)) bar.currentData.scores.remove(oldUser);
        if (hidden) return;
